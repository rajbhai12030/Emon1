...
<head>
  ...
  <script src="https://adexora.com/cdn/ads.js?id=504"></script>
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="developer" onclick="window.location.href='https://'">Developer by ER Emon Raj</div>
        </div>
        ...
        <div class="content">
            ...
            <div class="ad-container">
                <div class="ad-label">ADEXORA REWARD AD</div>
                <div class="buttons">
            ...
            <div class="website-section">
                ...
                <button class="btn-3d btn-blue" onclick="window.open('https://otieu.com/4/9640609', '_blank')">Visit Website</button>
            </div>
        </div>
    ...
    <script>
        ...
        function initApp() {
            ...
            document.getElementById('user-name').textContent = `User${Math.floor(1000 + Math.random() * 9000)}`;
        ...
        // Watch ad function using Adexora
        function watchAd() {
            // Show ad notification
            showAdNotification("Loading Adexora ad... Please wait");
            
            // Call Adexora ad function
            if (typeof window.showAdexora === 'function') {
                window.showAdexora()
                    .then(() => {
                        // SUCCESS: Ad shown successfully - REWARD LOGIC
                        watchedAdsCount++;
                    ...
                    .catch(error => {
                        // ERROR: Ad failed to show or was closed early
                        console.error("Adexora Ad error:", error);
                        showAdNotification("Failed to show ad. Please try again.");
                    });
            } else {
                // Fallback if the ad script hasn't loaded
                console.error("Adexora script not loaded.");
                showAdNotification("Ad system not ready. Please refresh or try again.");
            }
        }
